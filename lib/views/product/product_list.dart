...
@override
  ...
  Widget build(BuildContext context) {
    myProductList = [product1, product2, product3, product4, product5, product6, product7, product8, product9, product10, product11, product12];
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextField(
            ...
            style: const TextStyle(color: appGreyColor ,fontWeight: FontWeight.w500,fontSize: 15),
            ...
            decoration: InputDecoration(
              ...
              label: const Padding(
                ...
                child: Text('Search keywords...',style: TextStyle(color: appGreyColor ,fontWeight: FontWeight.w500,fontSize: 15),),
              ),
